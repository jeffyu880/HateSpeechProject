...
train_ROI = torch.load("harmeme_saved_feat_ROIENT/harmeme_ROI_MOMENTA/pol/harmfulness/harmeme_pol_train_ROI.pt")#, map_location=torch.device('cpu'))
val_ROI = torch.load("harmeme_saved_feat_ROIENT/harmeme_ROI_MOMENTA/pol/harmfulness//harmeme_pol_val_ROI.pt") #, map_location=torch.device('cpu'))
test_ROI = torch.load("harmeme_saved_feat_ROIENT/harmeme_ROI_MOMENTA/pol/harmfulness//harmeme_pol_test_ROI.pt") #, map_location=torch.device('cpu'))
# # # Load the ENT features
train_ENT = torch.load("harmeme_saved_feat_ROIENT/harmeme_ENT_MOMENTA/pol/harmeme_pol_harmfulness/harmeme_pol_train_ent.pt") #, map_location=torch.device('cpu'))
val_ENT = torch.load("harmeme_saved_feat_ROIENT/harmeme_ENT_MOMENTA/pol/harmeme_pol_harmfulness/harmeme_pol_val_ent.pt") #, map_location=torch.device('cpu'))
test_ENT = torch.load("harmeme_saved_feat_ROIENT/harmeme_ENT_MOMENTA/pol/harmeme_pol_harmfulness/harmeme_pol_test_ent.pt") #, map_location=torch.device('cpu'))
...
clip_model = torch.jit.load("ViT-B-32.pt").cuda().eval()
